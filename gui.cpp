...
namespace gui {
	...
	static boost::container::flat_set<std::string>* sLoaderMods;
	...
	static void RefreshListBoxItems() {
		...
		boost::container::flat_set<std::string>& loaderMods = *sLoaderMods;
	...
	bool WinMain(HINSTANCE hInstance, std::vector<ModInfo>* mods, boost::container::flat_set<std::string>* loaderMods) {
		sMods = mods;
